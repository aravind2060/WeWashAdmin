 ...
 */
public class FoldedOrders extends Fragment {
   ...
   private ArrayList<DisplayOrders> arrayListOrders=new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_folded_orders, container, false);
    ...
    private void setRecyclerView(View view) {
        RecyclerView recyclerView=view.findViewById(R.id.recycle_folded);
        LinearLayoutManager manager = new LinearLayoutManager(getContext());
        recyclerView.setLayoutManager(manager);
        recyclerView.setHasFixedSize(true);
        myAdapterForOrdersDisplay=new FoldedOrders.MyAdapterForOrdersDisplay(arrayListOrders);
    ...
    class MyAdapterForOrdersDisplay extends RecyclerView.Adapter<FoldedOrders.MyAdapterForOrdersDisplay.ViewHolderClass>
    {
       ...
       MyAdapterForOrdersDisplay(ArrayList<DisplayOrders> arrayList1)
        ...
        @NonNull
        @Override
        public FoldedOrders.MyAdapterForOrdersDisplay.ViewHolderClass onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

            View view=LayoutInflater.from(getContext()).inflate(R.layout.card_layout,parent,false);
            return new FoldedOrders.MyAdapterForOrdersDisplay.ViewHolderClass(view);
        }
        ...
        public void onBindViewHolder(@NonNull ViewHolderClass holder, int position) {
            ...
            holder.orders_btn.setText("Delivered");
            holder.orders_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    FirebaseDatabase.getInstance().getReference("Admin").child("Orders").child("FoldedOrders").child(UKey).removeValue();
