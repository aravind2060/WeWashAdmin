...
public class DeliveredOrders extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_delivered_orders, container, false);
    ...
    private void setRecyclerView(View view) {
        RecyclerView recyclerView=view.findViewById(R.id.recycle_delivered);
        LinearLayoutManager manager = new LinearLayoutManager(getContext());
        recyclerView.setLayoutManager(manager);
        recyclerView.setHasFixedSize(true);
        myAdapterForOrdersDisplay=new DeliveredOrders.MyAdapterForOrdersDisplay(arrayListOrders);
        recyclerView.setAdapter(myAdapterForOrdersDisplay);
    }

    private void getArrayListData()
    {
        DatabaseReference databaseReference= FirebaseDatabase.getInstance().getReference("Admin").child("Orders").child("DeliveredOrders");
    ...
    class MyAdapterForOrdersDisplay extends RecyclerView.Adapter<DeliveredOrders.MyAdapterForOrdersDisplay.ViewHolderClass>
    {
        ...
        @NonNull
        @Override
        public DeliveredOrders.MyAdapterForOrdersDisplay.ViewHolderClass onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

            View view=LayoutInflater.from(getContext()).inflate(R.layout.card_layout,parent,false);
            return new DeliveredOrders.MyAdapterForOrdersDisplay.ViewHolderClass(view);
        }
        ...
        public void onBindViewHolder(@NonNull ViewHolderClass holder, int position)
        {
            ...
            holder.orders_btn.setText("Done");
            holder.orders_btn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {

//                    DatabaseReference databaseReference=FirebaseDatabase.getInstance().getReference("Admin").child("Orders").child("DeliveredOrders");
//                    DisplayOrders displayOrders = new DisplayOrders(proorderId,proname,proaddress,proarea,prophone,prodate,protime,proclothes,prostatus,proprogress,UKey,proservice);
