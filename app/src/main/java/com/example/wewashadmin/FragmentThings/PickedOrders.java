 ...
 */
public class PickedOrders extends Fragment {

   private String UKey;
    private String proorderId, proname, proaddress, proarea, prophone, prodate, protime, proclothes,prostatus;
   ...
   private MyAdapterForOrdersDisplay myAdapterForOrdersDisplay;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_picked_orders, container, false);
    ...
    private void setRecyclerView(View view) {
        RecyclerView recyclerView=view.findViewById(R.id.recycle_picked);
        LinearLayoutManager manager = new LinearLayoutManager(getContext());
        recyclerView.setLayoutManager(manager);
        recyclerView.setHasFixedSize(true);
        myAdapterForOrdersDisplay=new PickedOrders.MyAdapterForOrdersDisplay(arrayListOrders);
    ...
    class MyAdapterForOrdersDisplay extends RecyclerView.Adapter<MyAdapterForOrdersDisplay.ViewHolderClass>
    {
       ...
       MyAdapterForOrdersDisplay(ArrayList<DisplayOrders> arrayList1)
        ...
        @NonNull
        @Override
        public PickedOrders.MyAdapterForOrdersDisplay.ViewHolderClass onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

            View view=LayoutInflater.from(getContext()).inflate(R.layout.card_layout,parent,false);
            return new PickedOrders.MyAdapterForOrdersDisplay.ViewHolderClass(view);
        }
        ...
        public void onBindViewHolder(@NonNull ViewHolderClass holder, int position) {
            ...
            holder.orders_btn.setText("Washed");
            holder.orders_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    taskMap.put("progress", 50);
                    FirebaseDatabase.getInstance().getReference("Admin").child("Orders").child("DisplayOrders").child(UKey).updateChildren(taskMap);
                    FirebaseDatabase.getInstance().getReference("Admin").child("Orders").child("PickedOrders").child(UKey).removeValue();
